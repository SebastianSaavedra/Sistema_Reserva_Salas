...
// class WorkDaysMonthView extends React.Component {
//   constructor(...args) {
//     super(...args)
...
// WorkDaysMonthView.title = (date, { localizer }) =>
//   localizer.format(date, 'monthHeaderFormat')

// export default WorkDaysMonthView